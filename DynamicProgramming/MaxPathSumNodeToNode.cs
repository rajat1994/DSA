...
public class Program{
	...
	static public void Main (){
		...
		MaxPathSumNodeToNode(root, ref res);
	...
	public static int MaxPathSumNodeToNode(Node root, ref int res){
		...
		int l = MaxPathSumNodeToNode(root.left, ref res);
		int r = MaxPathSumNodeToNode(root.right, ref res);
